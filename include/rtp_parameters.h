...
#ifndef WINDOWS_RTP_PARAMETERS_H
#define WINDOWS_RTP_PARAMETERS_H
...
struct RtpParameters : public RefCountInterface {
 public:
  static scoped_refptr <RtpParameters> Create();
  virtual std::string GetTransactionId() = 0;
  virtual void SetTransactionId(std::string value) = 0;

  virtual std::string GetMid() = 0;
  virtual void SetMid(std::string value) = 0;

  virtual std::vector<RtpCodecParameters> GetCodecs() = 0;
  virtual void SetCodecs(std::vector<RtpCodecParameters> value) = 0;

  virtual std::vector<RtpExtension> GetHeaderExtensions() = 0;
  virtual void SetHeaderExtensions(std::vector<RtpExtension> value) = 0;

  virtual std::vector<RtpEncodingParameters> GetEncodings() = 0;
  virtual void SetEncodings(std::vector<RtpEncodingParameters> value) = 0;
...
class RtpEncodingParameters : public RefCountInterface {
 public:
  RtpEncodingParameters();
  RtpEncodingParameters(const RtpEncodingParameters&);
  ~RtpEncodingParameters();

  static scoped_refptr<RtpEncodingParameters> Create();
  ...
  virtual Priority GetNetworkPriority() = 0;
  virtual void SetNetworkPriority(Priority value) = 0;
  ...
  virtual std::string GetScalabilityMode() = 0;
  virtual void SetScalabilityMode(std::string value) = 0;

  virtual bool GetActive() = 0;
  virtual void SetActive(bool value) = 0;

  virtual std::string GetRid() = 0;
  virtual void SetRid(std::string value) = 0;

  virtual bool GetAdaptivePtime() = 0;
  virtual void SetAdaptivePtime(bool value) = 0;

  virtual bool operator==(const RtpEncodingParameters& o) const  = 0;
  virtual bool operator!=(const RtpEncodingParameters& o) const = 0;
